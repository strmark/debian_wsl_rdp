...
When running the command az login you can get an error on azure-mgmt-rdbms. The command ``python3 -m pip config set global.break-system-packages true`` should have been run.
